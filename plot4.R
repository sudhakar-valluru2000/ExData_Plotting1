...
# split the page layout into four parts which would be 2 rows and 2 columns using layout function

#layout(matrix(c(1,1,0,2), 2, 2, byrow = TRUE))
layout(matrix(c(1,2,3,4), nrow = 2, ncol = 2,  byrow = TRUE))

#First left
plot(r1$timestamp, r1$Global_active_power, type="l", ylab = "Global Active Power", xlab = "") 
#layout.show(nf)

#First Right
plot( r1$timestamp, r1$Voltage, type="l", ylab = "Voltage", xlab = "datetime") 
...
legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), pch = "-", lwd = 0.2)

#Bottom Right

plot(r1$timestamp, r1$Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_reactive_power") 
